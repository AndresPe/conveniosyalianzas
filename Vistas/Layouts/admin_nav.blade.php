...
<header>
    <div id="navbarToggleExternalContent">
        <nav class="navbar navbar-light" id="topnav" style="background-color: #c40c1c;">
            ...
            <div> <a id="texto" href="{{ URL::route('ConveniosInter.index') }}"> Internacionales</a> </div>
            <div> <a id="texto" href="{{ URL::route('Intercambios.index') }}"> Intercambios </a> </div>
            <div> <a id="texto" > Solicitudes Académicas</a> </div>
            <div> <a id="texto" > Solicitudes Intercambio</a> </div>
